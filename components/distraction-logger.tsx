    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={close}>
      <View style={styles.overlay}>
        ...
        <CommandCard accent={colors.warning} style={styles.sheet}>
          ...
          {showOtherNote ? <>
            <TextInput value={otherNote} onFocus={onInputFocus} onChangeText={setOtherNote} maxLength={140} placeholder="Optional note" placeholderTextColor={colors.muted} style={[styles.noteInput, { color: colors.foreground, borderColor: colors.border, backgroundColor: colors.background }]} returnKeyType="done" onSubmitEditing={() => log("other", otherNote)} />
...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "#00000066", padding: 14 }, modalContent: { flexGrow: 1, justifyContent: "flex-end" }, sheet: { gap: 11, maxHeight: "78%" }, sheetEyebrow: { fontSize: 9, lineHeight: 12, fontWeight: "900", letterSpacing: 0.9 }, sheetTitle: { fontSize: 19, lineHeight: 24, fontWeight: "900" }, sheetDetail: { fontSize: 12, lineHeight: 17, fontWeight: "600", marginTop: -6 },
