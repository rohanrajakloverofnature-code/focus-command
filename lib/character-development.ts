...
export type CharacterCinematicVariant = "tactical" | "command" | "shadow" | "ascendant" | "tacticalEvolution" | "commandEvolution" | "baseAscendant" | "sovereignAscendant";
...
export function getCharacterCinematicVariant(title: string, level = 0): CharacterCinematicVariant {
  ...
  if (portrait === "evolutionAscendant") return "sovereignAscendant";
